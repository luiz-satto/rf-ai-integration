...
class RobotListenerV2:
    ...
    def end_test(self, name, attrs):
        ...
        if attrs['status'] == 'PASS':
            ...
            jira_project_name = 'RF + AI Test'
            jira_reporter = 'currentUser()'
            # existing_issue = self.jira.get_issues("project = '" + jira_project_name + "' and Reporter = " + jira_reporter + " and summary ~ '" + attrs['longname'] + "'")
            # existing_issue = self.jira.get_issues("project = '" + jira_project_name + "'")
            existing_issue = self.jira.get_issues("Reporter = '" + jira_reporter + "'")
            chat_gpt_message = ""
